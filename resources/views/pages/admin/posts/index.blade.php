            ...
            <table class="w-full border border-collapse border-gray-400">
                ...
                <tbody class="border border-gray-400 text-center">
                    ...
                    <tr>
                        ...
                        <td class="border border-gray-400">
                            <a href="{{ route('admin.posts.show', $item->id) }}" class="hover:underline">
                                {{ $item->title }}
                            </a>
                        </td>
                        <td class="border border-gray-400">
                            <div class="flex justify-center items-center space-x-4 m-1">
                                <a href="{{ route('admin.posts.show', $item->id) }}" class="bg-blue-500 text-white px-4 py-1 hover:bg-blue-600 active:bg-blue-700 rounded-sm">
                                    View
                                </a>
                                <a href="#"
                                    class="bg-green-500 text-white px-4 py-1 hover:bg-green-600 active:bg-green-700 rounded-sm">Edit</a>
                                <a href="#"
                                    class="bg-red-500 text-white px-4 py-1 hover:bg-red-600 active:bg-red-700 rounded-sm">Delete</a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
